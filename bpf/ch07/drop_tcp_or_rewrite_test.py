...
#
# ```sh
# $ sudo python drop_tcp_or_rewrite_test.py
# .
# ----------------------------------------------------------------------
# Ran 1 test in 2.249s
#
# OK
# ```
...
class DropTCPOrRewriteTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.bpf_function = bpf_prog.load_func(b"drop_tcp_or_rewrite", BPF.XDP)
